...
| declarator
{$$=setFunctionDeclaratorSpecifier($1,makeSpecifier(int_type,0));}compound_statement
...
;
direct_declarator
: IDENTIFIER {$$=makeIdentifier($1);}| LP declarator RP {$$=$2;}
...
{$$=makeNode(N_EXP_PRE_DEC,NIL,$2,NIL);}| AMP cast_expression
